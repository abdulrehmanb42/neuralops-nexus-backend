...
repository (issues, pull requests, discussions), the Project board, and any
other official communication channels — and also applies when an individual
is officially representing the community in public spaces.

## Enforcement

Instances of abusive, harassing, or otherwise unacceptable behavior may be
reported to the project maintainer at **noamanfaisal@gmail.com**. All
...
2. **Warning** — a warning with consequences for continued behavior,
   including temporary restriction from interaction.
